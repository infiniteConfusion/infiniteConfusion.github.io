...
from level_2 import main as level_2_main
...
def main():
    ...
    barrier_width = 25
    barrier_color = grey
    barrier_left = Platform(0, -400, barrier_width, 1000)
    barrier_right = Platform(floor_width - barrier_width, -400, (barrier_width + 5), 1000)
    ...
    all_sprites.add(player, platform1, platform2, barrier_left, barrier_right)

    platforms = pygame.sprite.Group()
    platforms.add(platform1, platform2)

    blue_box = BlueBox(platform2.rect.x, platform2.rect.y - 50, 150, 50)
