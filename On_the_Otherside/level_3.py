...
from level_4 import main as level_4_main
...
def main():
    ...
    barrier_width = 25
    barrier_color = grey
    barrier_left = Platform(0, -900, barrier_width, 1500)
    barrier_right = Platform(floor_width - barrier_width, -900, (barrier_width + 5), 1500)
    ...
    platform1 = Platform(500, 400, 250, 10)
    platform2 = Platform(300, 200, 150, 10)
    platform3 = Platform(270, 0, 50, 10)
    platform4 = Platform(750, -170, 120, 10)
    platform5 = Platform(1200, 0, 50, 10)
    platform6 = Platform(1700, -195, 100, 10)
    platform7 = Platform(1300, -500, 75, 10)
    platform8 = Platform(900, -770, 50, 10)
    platform9 = Platform(850, -900, 150, 10)

    all_sprites = pygame.sprite.Group()
    all_sprites.add(player, platform1, platform2, platform3, platform4, barrier_left, platform5, platform6, platform7, platform8, platform9, barrier_right)

    platforms = pygame.sprite.Group()
    platforms.add(platform1, platform2, platform3, platform4, platform5, platform6, platform7, platform8, platform9)
    ...
    blue_box = BlueBox(platform9.rect.x, platform9.rect.y - 50, 150, 50)
